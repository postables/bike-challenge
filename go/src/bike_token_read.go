...
func main() {
	...
	token, err := bike_token.NewBikeToken(common.HexToAddress("0x8e5f41b551108279d360ab47ec461d53f03bc5a6"), conn)
	if err != nil {
		log.Fatalf("error instantiating token instance")
	}
	...
	ownerBalance, err := token.BalanceOf(nil, owner)
	if err != nil {
